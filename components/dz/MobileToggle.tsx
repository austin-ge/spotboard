...
export default function MobileToggle({
  ...
  return (
    <button
      onClick={onToggle}
      className="fixed bottom-6 right-6 z-50 md:hidden rounded-full w-14 h-14 flex items-center justify-center shadow-2xl active:scale-95 transition-all bg-[#0c1018]/90 backdrop-blur-sm border border-slate-700/50 text-white"
